...
// import TableSortButtons from "@/components/shared/TableSortButtons";
...
//       toast.error("Hanya admin yang dapat mengubah status.");
//       return;
//     }
...
//             />
//           </th>
//           <th className={headerCellClasses}>NIK Pengajuan</th>
//           <th className={headerCellClasses}>Nama Pengajuan</th>
//           <th className="hidden md:table-cell border border-gray-300 px-2 py-4 text-left text-xs font-medium text-gray-700">
//             Alasan Pengajuan
//           </th>
//           <th className="hidden md:table-cell border border-gray-300 px-2 py-4 text-left text-xs font-medium text-gray-700">
//             Estimasi Rekam Ulang
//           </th>
//           <th className={headerCellClasses}>
//             Status
//             <TableSortButtons
...
//                       <td className={bodyCellClasses}>{item.nik_pengajuan}</td>
...
//                       </td>
//                       <td className="hidden md:table-cell border border-gray-300 px-2 py-4 text-xs">
//                         {formatDate(item.estimasi_tanggal_rekam_ulang)}
//                       </td>
...
//                             <p><strong>NIK Pengajuan:</strong> {item.nik_pengajuan}</p>
//                             <p><strong>Nama Pengajuan:</strong> {item.nama_pengajuan}</p>
...
//                             </p>
//                             <p>
//                               <strong>Estimasi Rekam Ulang:</strong>{" "}
//                               {formatDate(item.estimasi_tanggal_rekam_ulang)}
//                             </p>
//                           </div>
//                         </td>
