        ...
        <table className={tableClasses}>
          <thead>
            <tr className={headerRowClasses}>
              ...
              <th className="hidden md:table-cell border border-gray-300 px-2 py-4 text-left text-xs font-medium text-gray-700">Nama Pemilik cliquez untuk melanjutkan Biometric</th>
